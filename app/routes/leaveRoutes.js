...
const { leaveRequest,LeaveAction,retriveMyAllLeaves,allocateLeaves,fetchLeavesByStatus,listAllLeaveApplications,allocatedLeaveSummary  } = require("../controllers/leaveController");
...
router.get("/fetchLeavesByStatus",verifyToken,fetchLeavesByStatus)
